const ChatHeader = ({ currentMode, onModeChange, isStreaming }) => {
  const baseButtonClasses =
    'py-3 px-5 sm:py-3.5 sm:px-8 rounded-[1.8rem] font-semibold transition-all duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed'
  ...
  return (
    <header className="flex flex-shrink-0 items-center justify-center rounded-none px-8 py-4 sm:py-6 lg:rounded-tl-xl lg:rounded-tr-xl">
